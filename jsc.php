...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 mt-5 mb-4">
            <h1 class="text-center font-weight-bold mt-5">Junior School Certificate (JSC)</h1>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col-lg-12">
            <p>The Junior School Certificate, also known as JSC, is a public examination taken by students in Bangladesh after successful completion of eight years of schooling. It is followed by Secondary School Certificate (SSC).[1]
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A consequatur deleniti et expedita ipsum laboriosam minima numquam, officia quae similique.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis error harum hic minima obcaecati odio.</p>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="text-primary">Junior School Certificate(J.S.C.)</h3>
            <p>Degree Details | Certificate | Transcript</p>
            <p>Meherpur Govt High School, Meherpur, Bangladesh</p>
