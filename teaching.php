...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 mt-5 mb-4">
            <h1 class="text-center font-weight-bold mt-5" style="font-size: 60px;">Teaching</h1>
        </div>
        <br>
        <div class="col-lg-12 mt-5">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aperiam commodi delectus est sapiente totam. Corporis deserunt ducimus, excepturi fugiat illum laudantium maxime nihil nostrum obcaecati omnis placeat quae quaerat quidem, quis ratione? Aliquam beatae culpa, cum doloremque dolores error eveniet, ex in incidunt nemo quam quos sapiente veritatis! Doloribus expedita iusto laudantium modi repellat sed tenetur! Assumenda incidunt</p>
        </div>
    </div>
